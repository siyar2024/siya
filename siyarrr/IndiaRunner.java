class IndiaRunner
{
	...
	India.state(stateName);
	
	int[] pincodeNo= {23,456,23,56,678,489,45,78};
	India.pincode(pincodeNo);
	...
	India.primeminister(primeministersName);
	...
	India.cabinetminister(cabinetministerName);
	...
	India.politicalpartie(politicalpartieName);
	}
}